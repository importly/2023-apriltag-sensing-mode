...
public class Apriltags {
	...
	private static Transform3d cameraToRobotCenter = new Transform3d(
			new Translation3d(Units.inchesToMeters(18), Units.inchesToMeters(0), Units.inchesToMeters(20)),
			new Rotation3d(0, Units.degreesToRadians(0), Units.degreesToRadians(0))).inverse();
	...
	public static void update() {
        ...
        //Apriltags.m_field.setRobotPose(robotPos.getTranslation().getX() + 16.485 / 2, robotPos.getTranslation().getY() + 8.193 / 2, new Rotation2d(robotPos.getRotation().getZ()));
	}
}